 ...
 * @author USER
 */
public class BrowerFrame1 extends javax.swing.JFrame {

    /**
     * Creates new form StudentFrame
     */
    public BrowerFrame1(String userName) {
        initComponents();
        Connect();
        BorrowerData();
...
private void BorrowerData() {
    try {
        ...
        String query = "SELECT bookid, studentname, book, date_borrowed, date_return, Status FROM borrowing WHERE Status='Borrowed'";
    ...
    if (userSelection == JFileChooser.APPROVE_OPTION) {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook()) {
            ...
            // Table Header
            String[] headers = {"Book ID", "Student Name", "Book Title", "Date Borrowed", "Date Return", "Status"};
            ...
            // Database data
            String query = "SELECT bookid, studentname, book, date_borrowed, date_return,  Status FROM borrowing";
            PreparedStatement stmt = con.prepareStatement(query);
            ResultSet rs = stmt.executeQuery();
...
public void sendEmail(String toEmail, String subject, String body) {
    ...
    private void initComponents() {
        ...
        ReportedButton = new javax.swing.JButton();
        ...
        jLabel1.setText("Librarian Borrowing Management!");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BookId", "StudentName", "Book", "BateBorrowed", "Date_Return"
            }
        ));
        ...
        ReportedButton.setBackground(new java.awt.Color(255, 102, 102));
        ReportedButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ReportedButton.setForeground(new java.awt.Color(255, 255, 255));
        ReportedButton.setText("Report Case");
        ReportedButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ReportedButtonActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(39, 39, 39)
                        .addComponent(ReportedButton, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(ReportedButton, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(77, 77, 77)))
...
try {
    ...
    // 2. Check if book exists and is not borrowed
    PreparedStatement checkBook = con.prepareStatement(
        "SELECT Status FROM books WHERE bookid = ? AND bookname = ?");
    checkBook.setString(1, id);
    checkBook.setString(2, book);
    ...
    if ("Borrowed".equalsIgnoreCase(bookStatus)) {
    ...
    // 4. Check if student is reported
    PreparedStatement checkReported = con.prepareStatement(
        "SELECT Reportedcase FROM reported WHERE studentname = ?");
    checkReported.setString(1, name);
    ResultSet reportedResult = checkReported.executeQuery();

    if (reportedResult.next()) {
        String reportedCase = reportedResult.getString("Reportedcase");
        JOptionPane.showMessageDialog(rootPane,
            "Borrowing Denied!\nStudent is reported for: " + reportedCase +
            "\nPlease resolve this issue before borrowing.",
    ...
    String subject = "Book Borrowed Successfully";
    String msg = String.format(
        "Dear %s,\n\nYou have successfully borrowed the book \"%s\" (ID: %s) on %s.\n" +
        "You are required to return it by %s.\n\nPlease avoid delays to prevent penalties.\n\nUR-CST Library",
        name, book, id, date_borrowed, date_return);
    sendEmail(email, subject, msg);
    ...
    private void ReportedButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReportedButtonActionPerformed
        // TODO add your handling code here:
try {
    String id = Id.getText();
    String name = Name.getText();
    String book = Book.getText();
    String reason = Role1.getSelectedItem().toString(); // Report reason (e.g., "Damaged Book", "Lost Book", etc.)
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    String email = null;
    PreparedStatement checkStudent = con.prepareStatement("SELECT email FROM students WHERE names = ?");
    checkStudent.setString(1, name);
    ResultSet studentResult = checkStudent.executeQuery();
    ...
    // 3. Insert into reported table
    insert = con.prepareStatement(
        "INSERT INTO reported(bookid, studentname, bookname, borroweddate, returneddate, Reportedcase) " +
        "VALUES (?, ?, ?, ?, ?, ?)");
    insert.setString(1, id);
    insert.setString(2, name);
    insert.setString(3, book);
    ...
    // 4. Email the student
    String subject = "Library Misconduct Report";
    String msg = String.format(
        "Dear %s,\n\nYou have been reported for the following case regarding the book \"%s\" (ID: %s):\n" +
        "Reason: %s\n\nBorrowed Date: %s\nReturn Date: %s\n\nPlease resolve this issue with the UR-CST library as soon as possible.\n\nThank you,\nUR-CST Library",
        name, book, id, reason, date_borrowed, date_return);
    sendEmail(email, subject, msg);

    // 5. Notify success
    JOptionPane.showMessageDialog(rootPane, "Reporting Added Successfully and Email Sent.");
    BorrowerData();
    ...
    }//GEN-LAST:event_ReportedButtonActionPerformed
...
//    }
 private String currentUserName;
    ...
    private javax.swing.JButton ReportedButton;
